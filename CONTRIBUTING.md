...
2. Preserve the documented native permission semantics. Do not silently select bypass, weaken Claude or organization policy, add arbitrary CLI flag passthrough, read the clipboard without an explicit command, log credentials, perform destructive Git cleanup, or alter authentication automatically.
